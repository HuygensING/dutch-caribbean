...
(function() {
  ...
  define('views/archive-search',['require','config','views/base','faceted-search','text!html/faceted-search-and-results.html','models/results-cache'],function(require) {
...
(function() {
  ...
  define('views/creator-search',['require','config','views/base','faceted-search','text!html/faceted-search-and-results.html','models/results-cache'],function(require) {
    var BaseView, FacetedSearch, Search, Templates, config, resultsCache, _ref;
    config = require('config');
    BaseView = require('views/base');
    FacetedSearch = require('faceted-search');
...
(function() {
  ...
  define('views/legislation-search',['require','config','views/base','faceted-search','text!html/faceted-search-and-results.html','models/results-cache'],function(require) {
    var BaseView, FacetedSearch, Search, Templates, config, resultsCache, _ref;
    config = require('config');
    BaseView = require('views/base');
    FacetedSearch = require('faceted-search');
...
(function() {
  ...
  define('views/home',['require','config','views/base','faceted-search','text!html/home.html','views/archive-search','views/creator-search','views/legislation-search','models/results-cache'],function(require) {
...
define('text!html/creator.html',[],function () { return '<div class="breadcrumbs"><div class="line"></div><ul><li><a href="/creator/results">Search results</a></li><% if (model.nameEng) { %><li class="active"><a href="/creator/<%= model._id %>"><%= model.nameEng.length > 70 ? model.nameEng.substr(0,70) + \'...\' : model.nameEng %></a></li><% } %></ul></div><div class="content"><div class="panel-left"><h2>Creator<span><%- model.nameEng %></span></h2><div class="history"><%= model.history %></div><% if (model.notes) { %><div class="remarks"><h4>Remarks</h4><%= model.notes %></div><% } %>\n<% if (_.has(model, \'relatedArchives\') && model.relatedArchives.length) { %><div class="related-archives"><h4>Related archives</h4><ul><% _.each(model.relatedArchives, function (archive) { %><li><a href="<%= config.archiveURL(archive.id) %>"><%- archive.displayName %></a></li><% }) %></ul></div><% } %>\n<% if (_.has(model, \'relatedArchivers\') && model.relatedArchivers.length) { %><div class="related-creators"><h4>Related creators</h4><ul><% _.each(model.relatedArchivers, function (archiver) { %><li><a href="<%= config.archiverURL(archiver.id) %>"><%- archiver.displayName %></a></li><% }) %></ul></div><% } %></div><div class="panel-right"><% if (_.has(model, \'subjectKeywords\') && model.subjectKeywords.length) { %><div class="subject"><h4>Subject</h4><% _.each(model.subjectKeywords, function (kw) { %><p><%= kw.displayName %></p><% }) %></div><% } %><div class="date"><h4>Date</h4><p>Begin date<span><%= model.beginDate %></span></p><p>End date<span><%= model.endDate %></span></p></div><% if (_.has(model, \'placeKeywords\') && model.placeKeywords.length) { %><div class="geography"><h4>Geography</h4><% _.each(model.placeKeywords, function (place) { %><p><%= place.displayName %></p><% }) %></div><% } %></div></div>';});
...
define('text!html/legislation.html',[],function () { return '<div class="breadcrumbs"><div class="line"></div><ul><li><a href="/legislation/results">Search results</a></li><% if (model.titleEng) { %><li class="active"><a href="/legislation/"><%= model.titleEng.length > 70 ? model.titleEng.substr(0,70) + \'...\' : model.titleEng %></a></li><% } %></ul></div><div class="content"><div class="panel-left"><h2>Legislation<span><%- model.titleEng %></span></h2><div class="contents"><%= model.contents %></div><div class="archival-source"><%= model.originalArchivalSource %></div></div><div class="panel-right"><% if (_.has(model, \'subjectKeywords\') && model.subjectKeywords.length) { %><div class="subject"><h4>Subject</h4><% _.each(model.subjectKeywords, function (kw) { %><p><%= kw.displayName %></p><% }) %></div><% } %><div class="relevant-dates"><h4>Relevant dates</h4><p>Date 1 <%= model.date1 %></p><p>Date 2 <%= model.date2 %></p></div><% if (_.has(model, \'placeKeywords\') && model.placeKeywords.length) { %><div class="geography"><h4>Geography</h4><% _.each(model.placeKeywords, function (place) { %><p><%= place.displayName %></p><% }) %>\n<% } %></div><% if (_.has(model, \'pages\') && model.pages) { %><div class="pages"><h4>Pages</h4>\t<%= model.pages %></div><% } %></div></div>';});
